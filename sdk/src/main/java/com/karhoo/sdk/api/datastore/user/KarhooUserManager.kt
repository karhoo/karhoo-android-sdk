...
class KarhooUserManager(private val sharedPreferences: SharedPreferences,
        ...
        set(value) {
            value?.let {
                sharedPreferences.edit()
                        ...
                        .putString(PROVIDER_VERSION, value.provider.version)
    ...
    private fun returnSavedPaymentProvider(): PaymentProvider? {
        ...
        val version = sharedPreferences.getString(PROVIDER_VERSION, null)
    ...
    companion object {
        ...
        private const val PROVIDER_VERSION = "payment_provider_version"
